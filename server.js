...
app.post('/departments/add', (req, res) => {
	dataService.addDepartment(req.body).then(() => res.redirect('/departments')).catch((err) => {
		res.status(500).send('Unable to add department');
	});
});

app.post('/department/update', (req, res) => {
	dataService.updateDepartment(req.body).then(() => res.redirect('/departments')).catch((err) => {
